package com.laika.laikagram.shared.infrastructure.web.spring;

import com.laika.laikagram.shared.application.media.UploadMedia;
import com.laika.laikagram.shared.domain.media.FailedUploadException;
import com.laika.laikagram.shared.infrastructure.media.firebase.FirebaseStorageMediaService;
